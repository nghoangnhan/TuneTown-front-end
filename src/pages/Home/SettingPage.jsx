...
const SettingPage = () => {
    const { getCookiesTheme, setCookiesTheme, setCookiesLanguage, getCookiesLanguage } = UseCookie();
    const { t, i18n } = useTranslation();
    const [darkTheme, setDarkTheme] = useState(
        getCookiesTheme() === "true" ? true : false
    );
