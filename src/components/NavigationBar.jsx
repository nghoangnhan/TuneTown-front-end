...
const NavigationBar = () => {
  ...
  return (
    <div>
      ...
      {/* Navigation Mobile  */}
      {isMobile && (
        <div className="z-50 flex flex-row items-center w-screen justify-evenly xl:hidden bg-backgroundComponentPrimary dark:bg-backgroundComponentDarkPrimary">
          <NavLink
            to="/"
            className={({ isActive }) =>
              isActive
                ? "h-fit min-w-[100px] p-2 px-2 bg-gradient-to-r from-[#6aca72] to-[#32b95b] font-bold hover:opacity-80 text-textNavbarNormal text-center rounded-lg"
                : "h-fit min-w-[100px] p-2 px-2 font-bold hover:text-[#6aca72] text-textNavbar dark:text-textNavbarDark text-center rounded-lg"
            }
          >
            <HomeIcon></HomeIcon>
          </NavLink>
